        ...
        <NormalPageTemplate>
            <main className="container mx-auto px-4 pt-8">
                ...
                <div className="prose max-w-none">
                    ...
                    <p>
                        この利用規約（以下、「本規約」）は、ShortcutTodo（以下、「作者」）がこのウェブサイト上で提供するTodoアプリケーション（以下、「本サービス」）の利用条件を定めるものです。
                    ...
                    <ol>
                        ...
                        <li>
                            <strong>ログインなしでの利用：</strong> ユーザーは、アカウント登録やログインを行わずに本サービスを利用することもできます。この場合、ユーザーのTodoデータはWebブラウザ上（ローカルストレージ）に保存されます。
                        </li>
                    </ol>
                    <p>
