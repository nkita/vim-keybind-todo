...
function Spinner({
    ...
    return (
        <div role="status">
            <svg aria-hidden="true" className={cn("w-8 h-8 animate-spin  ring-0 border-0 outline-none", className)} viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
